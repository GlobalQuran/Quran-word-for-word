$(document).ready(function(){
  ...
  var get_absolute_url = function(qaree_id, sura_id, aya_id) {
    ...
    if (qaree_audio_is_secure(qaree_id)) {
      ...
      return base_url + hash[0] + "/" + hash + "." + qaree_audio_format(qaree_id)
    }
    else
  ...
  $("#current").bind("mousedown touchstart", function(e){
    e.preventDefault()  // handle either mouse or touch, but not both!
    var aya = parseInt(aya_select.val())
      aya_select.val(aya).change()
  })
